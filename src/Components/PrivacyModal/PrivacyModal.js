...
const PrivacyModal = ({ showPrivacyModal, showPolicyModal, onClosePrivacy, onClosePolicy }) => {
  return (
    <>
      {/* Модальное окно с согласием на обработку персональных данных */}
      {showPrivacyModal && (
        <div className="kvis-privacy-modal-overlay" onClick={onClosePrivacy}>
          <div className="kvis-privacy-modal" onClick={(e) => e.stopPropagation()}>
            <button className="kvis-privacy-modal-close" onClick={onClosePrivacy}>
      ...
      {showPolicyModal && (
        <div className="kvis-privacy-modal-overlay" onClick={onClosePolicy}>
          <div className="kvis-privacy-modal" onClick={(e) => e.stopPropagation()}>
            <button className="kvis-privacy-modal-close" onClick={onClosePolicy}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18M6 6L18 18" stroke="#000000" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </button>
