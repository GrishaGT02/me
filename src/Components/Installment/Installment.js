      ...
      <div className="installment-card">
        <div className="installment-card-left">
          ...
          <p className="installment-card-description">
            0% переплаты. Вы платите только стоимость лечения, разделенную на 6 равных частей. Оставьте заявку и менеджер предложит варианты рассрочки от наших банков-партнеров
          </p>
          <button className="installment-button" onClick={handleClick}>
            <span>Оформить рассрочку онлайн</span>
