...
import doctorImage from '../../assec/block9.png';
                    ...
                    <div className="guarantees-consultation-content">
                        ...
                        <div className="guarantees-consultation-text-block">
                            <h2 className="guarantees-consultation-title">
                                Наша лучшая реклама - Ваши улыбки!
                            </h2>
                            <p className="guarantees-consultation-description">
                            Мы дорожим своей репутацией и делаем всё, чтобы она была безупречной! Поэтому большинство наших пациентов рекомендуют нас своим родным и близким!
                            </p>
                        </div>
